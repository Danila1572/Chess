...
class ChessUI:
    ...
    def load_images(self):
        self.piece_images = {
            ...
            'Nw': pygame.image.load(os.path.join('assets', 'images', 'white_knight.png')).convert_alpha(),
            ...
            'Nb': pygame.image.load(os.path.join('assets', 'images', 'black_knight.png')).convert_alpha(),
